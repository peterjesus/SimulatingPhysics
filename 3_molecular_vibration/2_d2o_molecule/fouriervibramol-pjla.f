...
************************************************************************
*
*     Programacion del calculo numerico de la periodicidad en la vibra
*     cion de una molecula haciendo uso de la transformada de Fourier
*
...
*valores por debajo de la frecuencia de Nyquist. Obtenemos frecuencia y potencia
      open(20,file='fouriervibramolx2.dat') 
      do j=0,n/2-1
         v=j*dv
         pot=gr(j)**2+gi(j)**2
         write(20,*) v,pot
