function y=sensibilidad(x01,x02,mu,n)

p=logistica(mu,x01,n);    %matriz con resultados de la ecuacion del sist dinamico discreto para x01
q=logistica(mu,x02,n);    %matriz con resultados de la ecuacion del sist dinamico discreto para x02
c=n-1;
d=0:1:c;
k=[d]';          %matriz columna de valores del 1 a n (indica  en que iteracion estamos)
format long
