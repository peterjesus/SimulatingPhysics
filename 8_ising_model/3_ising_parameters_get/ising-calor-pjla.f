...
************************************************************************
      ...
      integer si,sj,energy,k,kmtc,ktemp,ntemp
      parameter(n=20,ntemp=100,nsim=10000)
      dimension m(0:n+1,0:n+1)
      character dimens*2
      write(dimens,'(i2)') n

      open(10,file='ising-calor-'//dimens//'.dat')
...
*Inicializacion de la energia y definicion de la J, la probabilidad del
*sorteo de sitios, el valor maximo del calor especifico y la temperatura
*asociada este valor
      l=1
      p=0.5d0
      cvc=0.0d0
